...
public class WordDto {
    ...
    public WordDto(Long id, String cocoClass, String enWord, String phonetic, String pos,
                   String definition, String translation, String exampleEn, String exampleVn) {
        this.id = id;
